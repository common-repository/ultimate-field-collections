...
<div id="<?php esc_attr_e($wrapper_id); ?>" class="<?php esc_attr_e($wrapper_class); ?>" <?php esc_attr_e( implode(' ', $wrapper_attrs) ); ?> >
	...
	<div class="acf-input">
		<div class="acf-input-wrap">
			...
			<div id="<?php esc_attr_e('editorjs-post-'.$ufc_field_post_id.'-acf-'.$field_key); ?>"></div>
			<pre class="ce-example__output-content" id="<?php esc_attr_e('editorjs-post-'.$ufc_field_post_id.'-acf-'.$field_key.'-output'); ?>"></pre>
