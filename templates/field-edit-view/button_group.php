    ...
    <div class="field-edit-content-main">
        ...
        <div class="field-edit-options-wrap">
            <div class="field-edit-content-row">
                <div class="field-edit-col field-col-half">
                    <label class="field-label"
                        for="acf_fields[<?php esc_attr_e($field_ID); ?>][choice_values][]"><?php esc_html_e('Option Label', "ufcsupport" ); ?></label>
                </div>
                <div class="field-edit-col field-col-half">
                    <label class="field-label"
                        for="acf_fields[<?php esc_attr_e($field_ID); ?>][choice_keys][]"><?php esc_html_e('Option Value', "ufcsupport" ); ?></label>
                </div>
            </div>
            <div class="field-edit-options-lists">
                ...
                <div class="field-edit-content-row">
                    <div class="field-edit-col field-col-half">
                        <input type="text" name="acf_fields[<?php esc_attr_e($field_ID); ?>][choice_values][]"
                            id="acf_fields[<?php esc_attr_e($field_ID); ?>][choice_values][]" class="ufc-field-input"
                            value="<?php esc_attr_e($choice_value); ?>">
                    </div>
                    <div class="field-edit-col field-col-half">
                        <input type="text" name="acf_fields[<?php esc_attr_e($field_ID); ?>][choice_keys][]"
                            id="acf_fields[<?php esc_attr_e($field_ID); ?>][choice_keys][]" class="ufc-field-input"
            ...
            <div class="field-edit-options-footer">
                <button class="button button-secondary button-large field-edit-new-option-add"><i
